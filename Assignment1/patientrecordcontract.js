...
class PatientRecordContract extends Contract {
    ...
    */
    ...
    async unknownTransaction(ctx){
        // GRADED FUNCTION
        throw new Error("Function name missing") // Misspelled in version 1
    }
    ...
    async createPatientRecord(ctx,username,name,dob,gender,blood_type){
        ...
        // throw new Error() // Part of original code
    ...
    async updateCheckupDate(ctx,username,name,lastCheckupDate){
        ...
        let precord = await ctx.patientRecordList.getPRecord(precordKey);
        precord.setlastCheckupDate(lastCheckupDate); // Follow the case sensitivity in the pdf
    ...
    */
    ...
    //      Pass the Query string built to queryWithQueryString
        let query = {
            ...
            "use_index" : ["_design/genderIndexDoc", "genderIndex"] // I think I was missing this. https://docs.couchdb.org/en/3.2.0/api/database/find.html
        };
        let recList = await this.queryWithQueryString(ctx, JSON.stringify(query));
    ...
    */
    ...
    //      Pass the Query string built to queryWithQueryString
        let query = {
            ...
            "use_index" : ["_design/blood_typeIndexDoc", "blood_typeIndex"] // I think I was missing this. https://docs.couchdb.org/en/3.2.0/api/database/find.html
        };
        let recList = await this.queryWithQueryString(ctx, JSON.stringify(query));
    ...
    */
    ...
    //      Pass the Query string built to queryWithQueryString
        ...
        let blood_type_qwqs = await this.queryWithQueryString(ctx, JSON.stringify(query));

        return blood_type_qwqs;
