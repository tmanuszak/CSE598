...
class PatientRecord extends State {
    ...
    // Maybe the variable name was the issue? Task 3 says the function and field are named as the following.
    getlastCheckupDate() { return this.lastCheckupDate } // getter for lastCheckup_Date
    setlastCheckupDate(newlastCheckupDate) { return this.lastCheckupDate=newlastCheckupDate } // setter for lastCheckupDate
